        ...
        <div class="col-md-10 col-md-offset-2">
            <div class="card">
                <div class="panel-body">
                    @include('learningnative.edit.errors')
                        ...
                        <div class="container">
                            ...
                            <div class="row">
                                <div class="col-md-10" style="margin-top:40px; margin-left:-180px">
                                    {!! Form::model($generatedWord, ['method'=>'PATCH', 'class'=>'form-horizontal', 'action' => ['LearningNativeWordsController@checkWord']]) !!}
                                    @include('learningnative.edit.form', ['buttonText' => 'Tłumacz'])
                                    {!! Form::close() !!}
                                </div>
                            </div>
                        </div>
